...
{
 uint8_t severity; ///< Severity of status. Relies on the definitions within RFC-5424. See enum BIKE_SEVERITY.
 ...
 *
 * @param severity Severity of status. Relies on the definitions within RFC-5424. See enum BIKE_SEVERITY.
 ...
 *
 * @return Severity of status. Relies on the definitions within RFC-5424. See enum BIKE_SEVERITY.
 */
